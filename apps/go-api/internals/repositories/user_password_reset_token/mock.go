...
type MockRepository struct {
	yca_repository.MockRepository[models.UserPasswordResetToken]
}
...
func (m *MockRepository) Create(tx yca_repository.Tx, token *models.UserPasswordResetToken) error {
...
func (m *MockRepository) GetByHash(tx yca_repository.Tx, tokenHash string) (*models.UserPasswordResetToken, error) {
