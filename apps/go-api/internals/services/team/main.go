...
type Service interface {
	Create(req *CreateRequest, accessInfo *models.AccessInfo) (*models.Team, error)
	Delete(req *DeleteRequest, accessInfo *models.AccessInfo) error
	List(req *ListRequest, accessInfo *models.AccessInfo) (*[]models.Team, error)
	Update(req *UpdateRequest, accessInfo *models.AccessInfo) (*models.Team, error)
}
